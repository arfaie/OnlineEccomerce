        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    IdSelectGroup = table.Column<int>(nullable: true),
                    IdFieldGroup = table.Column<int>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Fields_FieldGroups_IdFieldGroup",
                        column: x => x.IdFieldGroup,
                        principalTable: "FieldGroups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Fields_SelectGroups_IdSelectGroup",
                        column: x => x.IdSelectGroup,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    IdSelectGroup = table.Column<int>(nullable: false),
                    Title = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SelectItems_SelectGroups_IdSelectGroup",
                        column: x => x.IdSelectGroup,
                        principalTable: "SelectGroups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Issenoble = table.Column<bool>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NatCode = table.Column<long>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AspNetUsers_Cars_IdCar",
                        column: x => x.IdCar,
                        principalTable: "Cars",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "ProductGroupFields",
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    IdCategory = table.Column<int>(nullable: false),
                    IdFaild = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductGroupFields", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProductGroupFields_Categories_IdCategory",
                        column: x => x.IdCategory,
                        principalTable: "Categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductGroupFields_Fields_IdFaild",
                        column: x => x.IdFaild,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Tell = table.Column<long>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Agencies", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Agencies_Cities_IdCity",
                        column: x => x.IdCity,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_InventoryChanges_Products_IdProduct",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdProduct = table.Column<int>(nullable: false),
                    Offertype = table.Column<short>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OfferItems_Offers_IdOffer",
                        column: x => x.IdOffer,
                        principalTable: "Offers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OfferItems_Products_IdProduct",
                        column: x => x.IdProduct,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PriceChanges_Products_IdProduct",
                        column: x => x.IdProduct,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductFields_Fields_IdField",
                        column: x => x.IdField,
                        principalTable: "Fields",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductFields_Products_IdProduct",
                        column: x => x.IdProduct,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductGalleries_Products_IdProduct",
                        column: x => x.IdProduct,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Plaque = table.Column<string>(nullable: true),
                    PostalCode = table.Column<long>(nullable: false),
                    Transferee = table.Column<string>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Addresses_AspNetUsers_IdUser",
                        column: x => x.IdUser,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Date = table.Column<DateTime>(nullable: false),
                    FactorCode = table.Column<long>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FactorItems_Factors_IdFactor",
                        column: x => x.IdFactor,
                        principalTable: "Factors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FactorItems_Products_IdProduct",
                        column: x => x.IdProduct,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IssuCode = table.Column<long>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Orders_Factors_IdFactor",
                        column: x => x.IdFactor,
                        principalTable: "Factors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FactorItems_IdFactor",
                table: "FactorItems",
                column: "IdFactor");

            migrationBuilder.CreateIndex(
                name: "IX_FactorItems_IdProduct",
                table: "FactorItems",
                column: "IdProduct");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Fields_IdFieldGroup",
                table: "Fields",
                column: "IdFieldGroup");

            migrationBuilder.CreateIndex(
                name: "IX_Fields_IdSelectGroup",
                table: "Fields",
                column: "IdSelectGroup");

            migrationBuilder.CreateIndex(
                name: "IX_InventoryChanges_IdProduct",
                table: "InventoryChanges",
                column: "IdProduct");

            migrationBuilder.CreateIndex(
                name: "IX_OfferItems_IdOffer",
                table: "OfferItems",
                column: "IdOffer");

            migrationBuilder.CreateIndex(
                name: "IX_OfferItems_IdProduct",
                table: "OfferItems",
                column: "IdProduct");

            migrationBuilder.CreateIndex(
                name: "IX_Orders_IdFactor",
                table: "Orders",
                column: "IdFactor");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PriceChanges_IdProduct",
                table: "PriceChanges",
                column: "IdProduct");

            migrationBuilder.CreateIndex(
                name: "IX_ProductFields_IdField",
                table: "ProductFields",
                column: "IdField");

            migrationBuilder.CreateIndex(
                name: "IX_ProductFields_IdProduct",
                table: "ProductFields",
                column: "IdProduct");

            migrationBuilder.CreateIndex(
                name: "IX_ProductGalleries_IdProduct",
                table: "ProductGalleries",
                column: "IdProduct");

            migrationBuilder.CreateIndex(
                name: "IX_ProductGroupFields_IdCategory",
                table: "ProductGroupFields",
                column: "IdCategory");

            migrationBuilder.CreateIndex(
                name: "IX_ProductGroupFields_IdFaild",
                table: "ProductGroupFields",
                column: "IdFaild");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SelectItems_IdSelectGroup",
                table: "SelectItems",
                column: "IdSelectGroup");
        }
